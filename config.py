...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'x+HelB9PlhONJnarf12NHMC+7dKRwbYojsOtaySS859ARi8qXtGvaYf89jXRMTig9Qrv5+lNl+WT+AStwBHBSA=='
    ...
    SQLALCHEMY_DATABASE_URI = (
        ...
        f"{SQL_DATABASE}?driver=ODBC+Driver+18+for+SQL+Server"
